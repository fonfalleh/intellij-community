...
public class CodeCompletionModel implements FsmModel {
  ...
  public void addIfHead() {
    ...
    assertCurrentCodeBlockEqualsIgnoringSpaces(expected);
  }
  ...
  private void assertCurrentCodeBlockEqualsIgnoringSpaces(String expected) {
    String actual = adapter.blockAroundCaret();
